...
public class Modificar extends JDialog {
	...
	public Modificar(LocalDate localDate) {
		...
		spinner_Fecha.setModel(new SpinnerDateModel(Fecha.toDate(localDate), null, null, Calendar.MONTH));
	...
	protected void okModificar(JSpinner jSpinner) {
		LocalDate localDate = Fecha.toLocalDate((Date) jSpinner.getValue());
